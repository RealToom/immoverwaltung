    ...
    data: [
      {
        ...
        content: "MUSTER-MIETVERTRAG (Wohnraum) – vor Verwendung anwaltlich prüfen\n\nzwischen\n\n{{landlord}} (Vermieter)\n\nund\n\n{{tenantName}} (Mieter)\n\n§ 1 Mietobjekt\nVermietet wird die Einheit {{unitNumber}} in der Immobilie „{{propertyName}}“.\n\n§ 2 Mietzeit\nDas Mietverhältnis beginnt am {{date}} und läuft auf unbestimmte Zeit.\n\n§ 3 Miete\nDie monatliche Nettokaltmiete beträgt {{amount}} EUR, zahlbar monatlich im Voraus bis zum 3. Werktag auf das vom Vermieter benannte Konto.\n\n§ 4 Betriebskosten (§ 556 BGB)\nDer Mieter trägt neben der Nettokaltmiete die Betriebskosten i. S. d. § 2 Betriebskostenverordnung (BetrKV) und leistet hierauf eine monatliche Vorauszahlung, über die jährlich abgerechnet wird (§ 556 Abs. 3 BGB). „Sonstige Betriebskosten“ (§ 2 Nr. 17 BetrKV) werden nur umgelegt, soweit hier ausdrücklich benannt: ____________________. Heiz- und Warmwasserkosten werden nach der HeizkostenV überwiegend verbrauchsabhängig abgerechnet.\n\n§ 5 Kaution (§ 551 BGB)\nDer Mieter leistet eine Mietsicherheit von ______ EUR (höchstens drei Nettokaltmieten). Der Vermieter legt sie insolvenzfest und getrennt von seinem Vermögen verzinslich an; die Zinsen stehen dem Mieter zu.\n\n§ 6 Kündigung (§ 573c BGB)\nDie ordentliche Kündigungsfrist des Mieters beträgt drei Monate. Für den Vermieter verlängert sie sich nach fünf Jahren auf sechs, nach acht Jahren auf neun Monate. Die Vermieterkündigung setzt ein berechtigtes Interesse voraus (§ 573 BGB).\n\n§ 7 Schönheitsreparaturen\nEine Übertragung ist nur wirksam bei renoviert übergebener Wohnung und ohne starre Fristen (st. Rspr. BGH); der Zustand ergibt sich aus dem Übergabeprotokoll.\n\n§ 8 Sonstiges\nÄnderungen bedürfen der Textform. Ist eine Bestimmung unwirksam, bleibt der Vertrag im Übrigen wirksam.\n\nOrt, Datum: {{date}}\n\n___________________________       ___________________________\n{{landlord}} (Vermieter)          {{tenantName}} (Mieter)\n\nHinweis: Muster ohne Gewähr. Vor Verwendung prüfen (u. a. Mietpreisbremse §§ 556d ff., Staffel-/Indexmiete §§ 557a/b BGB).",
        companyId: company.id,
      },
      {
